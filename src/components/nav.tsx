...
export default function Nav() {
    ...
    return (
        <nav aria-label="Main Navigation" className="fixed top-0 w-full z-50 border-b border-white/5 bg-black/20 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                <div className="text-xl font-bold tracking-tighter uppercase"><SmoothLink href='#hero-section' aria-label="Aetheria Home">Aetheria</SmoothLink>  </div>
